...
class duplication_errors extends \core\event\base {
    ...
    protected function validate_data() {
        if (!isset($this->data['other']['newcategoryid']) or !isset($this->data['other']['errors'])) {
            throw new \coding_exception('newcategoryid and errors are mandatory in \'other\'.');
        }
    }

    public static function get_name() {
        return get_string('event_duplication_errors', 'local_courseduplication');
    }

    public function get_description() {
        return "The duplication of course {$this->objectid} to category ".
            "{$this->data['other']['newcategoryid']} had the following ".
            "errors: {$this->data['other']['errors']}.";
    }
